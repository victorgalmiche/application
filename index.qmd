...
```{ojs}
apiRoot = "https://titanic-ensae.lab.sspcloud.fr"
```
...
Retrouver l'API sur [https://titanic-ensae.lab.sspcloud.fr/docs](https://titanic.lab.sspcloud.fr/docs) pour jouer avec
d'autres exemples. 
